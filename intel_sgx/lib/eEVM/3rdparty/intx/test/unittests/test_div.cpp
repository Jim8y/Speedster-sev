...
.shift, 63);
EXPECT_EQ(na
.num_denominator_words, 1);
EXPECT_EQ(na
.num_numerator_words, 0);
EXPECT_EQ(na
.numerator, 0);
EXPECT_EQ(na
.numerator_ex, 0);
...
.shift, 60);
EXPECT_EQ(na
.num_denominator_words, 5);
EXPECT_EQ(na
.num_numerator_words, 5);
EXPECT_EQ(na
.numerator, u << 60);
EXPECT_EQ(na
.numerator_ex, 0);
...
.shift, 0);
EXPECT_EQ(na
.num_denominator_words, 3);
EXPECT_EQ(na
.num_numerator_words, 8);
EXPECT_EQ(na
.numerator, u);
EXPECT_EQ(na
.numerator_ex, 0);
...
.
denominator *t
.quotient + t.reminder, t.numerator);
...
EXPECT_EQ(v, reciprocal_naive(d)
) <<
d;
}
