...
App_Include_Paths := -IInclude -I$(UNTRUSTED_DIR) -Iservice_provider -I$(SGX_SDK)/include -I/usr/include/python2.7 -Iuntrusted/libs/ -Iuntrusted/libs/remote_attestation/ -Iuntrusted/libs/restclient-cpp -Iuntrusted/libs/jsoncpp
