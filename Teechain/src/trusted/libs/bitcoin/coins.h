...
*/
    bool operator()(const uint256& txid1, const uint256& txid2) const {
        size_t hash1 = SipHashUint256(k0, k1, txid1);
        size_t hash2 = SipHashUint256(k0, k1, txid2);
        return hash1 < hash2;
    }
};
...
typedef std::map<uint256, CCoinsCacheEntry, SaltedTxidHasher> CCoinsMap;
