...
teechain_Include_Paths := -IInclude -Itrusted -Iservice_provider -I$(SGX_SDK)/include -I$(SGX_SDK)/include/tlibc -I$(SGX_SDK)/include/libcxx -I$(SGX_SDK)/include/stlport -I$(SGX_SDK)/include/stdc++ -Itrusted/ -Itrusted/libs/ -Itrusted/libs/bitcoin -Itrusted/libs/bitcoin/config -Itrusted/libs/bitcoin/univalue/include -Itrusted/libs/bitcoin/secp256k1/ -Itrusted/libs/bitcoin/secp256k1/include/ -Itrusted/libs/ -Itrusted/libs/remote_attestation
